...
> [!TIP]
> Swipe right/left between albums (mobile browsers). Scrolling between songs instead of using the navigation links/buttons is possible, but not recommended - actually, it is actively discouraged with huge blank spaces!
