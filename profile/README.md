...
> [!TIP]
> Swipe right/left between albums (mobile/in-app browsers).<br/><br/>Navigate the README Music Player like a Wikipedia table — try their FAQ (Wikipedia) for an example.
