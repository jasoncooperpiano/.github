...
> [!TIP]
> Swipe right/left between albums (mobile browsers only; all albums should display side-by-side on desktop).<br/><br/>Scrolling between songs instead of using the navigation links/buttons is possible, but not recommended - actually, it is actively discouraged with huge blank spaces!
