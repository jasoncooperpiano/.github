...
> [!TIP]
> Swipe right/left between albums.<br/><br/>Mobile and in-app browsers preferred — GitHub iOS app not supported.<br/><br/>The navigation links/buttons work like a Wikipedia table — Try [their FAQ (Wikipedia)](https://en.wikipedia.org/wiki/Wikipedia:FAQ) for an example.
